export const sanitize = {
  ...
  "abbr[title]": { textDecoration: ["underline", "underline dotted"] },
  ...
  textarea: { margin: "0", overflow: "auto", resize: ["vertical", "block"] },
  ...
  dialog: {
    ...
    color: "black",
    display: "block",
    height: ["-moz-fit-content", "-webkit-fit-content", "fit-content"],
    left: "0",
    margin: "auto",
    padding: "1em",
    position: "absolute",
    right: "0",
    width: ["-moz-fit-content", "-webkit-fit-content", "fit-content"]
  },
